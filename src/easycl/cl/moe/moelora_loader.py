...
def load_moelora_model(
    ...
    r"""
    Loads pretrained model with MoE-LoRA support.
    
    Support MoE-LoRA training.
    ...
    # This is the only part we change - replace init_adapter with init_moelora_adapter
    model = init_moelora_adapter(
        config=config,
        model=model,
